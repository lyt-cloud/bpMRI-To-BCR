...
# 源文件夹和目标文件夹的根目录
source_root = "../datasets_all/datasets_suzhou_n4/diease_folder"
target_root = "../datasets_all/datasets_suzhou_n4/diease_folder_rgb"
...
for subdir in os.listdir(source_root):
    ...
    for filename in os.listdir(source_subdir):
        if filename.endswith(".png"):
            ...
            # 保存到目标文件夹
            r.save(os.path.join(target_R, subdir, filename))
            g.save(os.path.join(target_G, subdir, filename))
            b.save(os.path.join(target_B, subdir, filename))
